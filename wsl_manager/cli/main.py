...
def show_help():
    ...
    print("=" * 50)
    print("Usage: wsl-manager [command]")
    print()
    print("Commands:")
    ...
    print()
    print("Examples:")
    print("  wsl-manager installed")
    print("  wsl-manager available")
    print("  wsl-manager gui")
    print()
...
def launch_gui():
    ...
    try:
        ...
        print("Make sure tkinter is installed and GUI components are available.")
    except Exception as e:
        print(f"Error launching GUI: {e}")
...
def main():
    ...
    if command == "installed":
        ...
        print("Use 'wsl-manager help' for available commands.")
